        ...
        data () {
            return {
                ...
                headers: [
                    ...
                    { text: 'Permissions', value: 'permissions', align: 'left', sortable: true },
                    { text: 'Groups', value: 'groups', align: 'left', sortable: true },
                    { text: 'Last Login', value: 'last_login', align: 'left', sortable: true },
                    { text: 'Active', value: 'active', align: 'left', sortable: true },
                ],
                selected: [],
                items: [],
                totalItems: 0,
